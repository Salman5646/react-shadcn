            ...
            <div className="container mx-auto max-w-5xl">
                ...
                <div className="grid grid-cols-2 md:grid-cols-4 gap-4 mb-12">
                    {cartItems.length > 0 ? (
                        ...
                        <div className="col-span-full border border-zinc-800 rounded-2xl p-16 text-center bg-zinc-900/30">
                ...
                {cartItems.length > 0 && (
                    <div className="mt-auto border-t border-zinc-800 pt-8 pb-12">
                        <div className="max-w-2xl mx-auto bg-zinc-900/50 rounded-xl border border-zinc-800 overflow-hidden">
                            <Table>
                                <TableCaption className="pb-4 text-zinc-500">
                                    Final checkout summary for your session.
                                </TableCaption>
